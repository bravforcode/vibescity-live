...
Find nearby hospitals, police, and fire stations from the seeded nationwide dataset.
"""
...
async def get_all_nearby_emergency(
    ...
    Data sourced from the seeded nationwide emergency_locations dataset.
    """
    ...
    return {
        ...
        "meta": {
            ...
            "data_source": "seeded_emergency_locations"
        }
    }
