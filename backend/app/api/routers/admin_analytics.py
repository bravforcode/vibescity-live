...
async def update_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Session update failed: {e}") from e
...
async def track_event(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Event tracking failed: {e}") from e
...
async def terminate_session(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Session termination failed") from e
...
async def get_dashboard(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Dashboard retrieval failed") from e
...
async def get_sessions(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Sessions retrieval failed") from e
...
async def manage_retention(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Retention management failed") from e
