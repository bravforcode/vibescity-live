  ...
  >
    ...
    <div class="p-3">
      ...
      <div class="flex items-start justify-between gap-2">
        ...
        <!-- Favorite Heart (Floating) -->
        <button
          @click.stop="emit('toggle-favorite', shop.id)"
          class="shrink-0 w-7 h-7 flex items-center justify-center rounded-full transition-all active:scale-90"
          :class="[
        ...
        >
          <svg
            ...
            class="w-4 h-4"
            :fill="
              favorites.includes(Number(shop.id)) ? 'currentColor' : 'none'
            "
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
      ...
      <div class="flex items-center gap-1 mt-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          :class="['w-3 h-3', isDarkMode ? 'text-white/30' : 'text-gray-400']"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
