...
const HARD_DEFAULTS = {
	...
	radar: {
		baseRadiusPx: 120,
		maxRadiusPx: 220,
		sweetSpotY: 0.65, // % from top; thumb zone in lower-middle
	},
	velocity: {
	...
	stability: {
		lockDwellMs: 600, // candidate must stay top for this long
		openRadiusPx: 80, // must be within this to auto-open
		exitRadiusPx: 160, // hysteresis: must leave beyond this to re-trigger
