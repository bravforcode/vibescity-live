    ...
    watchId = navigator.geolocation.watchPosition(
      ...
      (error) => {
        ...
        if (error.code === error.PERMISSION_DENIED) {
          ...
          locationError.value = "Location access denied. Please enable it in browser settings.";
        } else if (error.code === error.TIMEOUT) {
          if (!userCoords.value) {
            locationError.value = "GPS signal lost or taking too long. Try an open area.";
          }
        } else {
