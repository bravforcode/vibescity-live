export const FLAG_GOVERNANCE = Object.freeze({
	...
	ff_locale_default_en_v1: {
		key: "ff_locale_default_en_v1",
		sunsetAfter: "2026-Q2",
		dependsOn: [],
		owner: "frontend-oncall",
	},
	ff_map_shader_safe_mode_v1: {
	...
	enable_web_vitals: {
		key: "enable_web_vitals",
		sunsetAfter: null,
		dependsOn: [],
		owner: "frontend-oncall",
	},
	enable_cinema_mall_explorer: {
		key: "enable_cinema_mall_explorer",
		sunsetAfter: null,
		dependsOn: [],
		owner: "frontend-oncall",
	},
	...
	enable_map_effects_pipeline_v2: {
		key: "enable_map_effects_pipeline_v2",
		sunsetAfter: "2026-Q2",
		dependsOn: [],
		owner: "frontend-oncall",
	},
