...
const messages = {
  th: {
    ...
    categories: {
      ...
      club: "คลับ",
      cafe_desc:
        "☕ ดื่มด่ำกับกาแฟพรีเมียมในบรรยากาศสุดชิลล์ เหมาะสำหรับนั่งทำงานหรือพักผ่อน",
      bar_desc:
        "🍸 บาร์ลับใจกลางเชียงใหม่ พร้อมเครื่องดื่มคราฟต์และดนตรีสุดคลาสสิก",
      ...
      music_desc:
        "🎸 ฟังดนตรีสดจากวงชื่อดังในบรรยากาศเป็นกันเอง พร้อมเครื่องดื่มเย็นฉ่ำ",
  ...
  en: {
    ...
    categories: {
      ...
      club_desc: "🪩 Unleash the fun with top DJs and full light and sound systems.",
      food_desc: "🍽️ Savor delicious flavors crafted from fine local ingredients.",
      music_desc:
