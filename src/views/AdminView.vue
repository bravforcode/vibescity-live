  ...
  <div class="admin-view p-6 bg-gray-900 min-h-screen text-white">
    ...
    <div v-if="activeTab === 'review'">
      ...
      <div v-else>
        ...
        <div v-if="pendingShops.length === 0" class="text-gray-400">
          No pending shops to review. Good job!
        </div>
            ...
            <div class="flex-1">
              ...
              <div class="flex gap-2">
                ...
                <button
                  ...
                  class="bg-purple-600 hover:bg-purple-500 text-white px-4 py-2 rounded transition-colors duration-150"
                >
                  Promote Giant
                </button>
                <button
      ...
      >
        ...
        <div class="flex flex-col sm:flex-row gap-2">
          ...
          <button
            ...
            class="bg-purple-700 hover:bg-purple-600 text-white px-4 py-2 rounded text-xs"
          >
    ...
    <div v-if="activeTab === 'usage'" class="mt-6">
      ...
      <div v-if="analyticsError" class="bg-red-500 text-white p-3 rounded mb-4">
        {{ analyticsError }}
      </div>

      <div v-if="analyticsLoading" class="text-center py-8 text-gray-400">
    ...
    >
      ...
      >
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block text-sm text-gray-400 mb-1">Anchor Rank</label>
            <input
              type="number"
