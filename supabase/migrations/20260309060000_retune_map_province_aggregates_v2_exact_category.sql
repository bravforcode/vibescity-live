-- =============================================================================
-- Migration: Retune Province Aggregate RPC v2 to Use Exact Category Matching
-- Date: 2026-03-09
-- Purpose:
--   1. Let PostgreSQL use the existing category/status map index efficiently
--   2. Keep the v2 RPC direct-filter contract while reducing category-filter latency
-- =============================================================================
...
AS $$
  ...
  resolved AS (
    ...
    LEFT JOIN province_lookup pl
      ON pl.lookup_key = lower(sv.province_input)
  )
  SELECT
