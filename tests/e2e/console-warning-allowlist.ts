...
export const CONSOLE_WARNING_ALLOWLIST: ConsoleAllowlistRule[] = [
	...
	{
		id: "map-tile-request-aborted",
		severity: "error",
		message: /Failed to load resource: net::ERR_ABORTED/i,
		source:
			/tiles\.(openfreemap|mapbox)\.org|\/(?:sprite|glyphs|tiles?)\/|\.pbf(?:$|\?)/i,
		note: "Tile requests can be canceled by headless Chromium during viewport churn.",
		reportable: false,
	},
	{
	...
	},
	{
		...
		severity: "error",
		message:
			/WebSocket connection to 'ws:\/\/127\.0\.0\.1:8000\/api\/v1\/vibes\/vibe-stream' failed/i,
